#run vs meta-pool but starting at 60M
...
input_bams = dir("bam_file_inputs/bam_files_H4_input_new_seq.60M_meta-pool/", pattern = "bam$", full.names = TRUE)
...
for(input_bam in input_bams){
  ...
  print(todo_df)
  psc2 = peaksat_config(out_dir = paste0("peaksat_outputs.input_saturation_metapool.60M/peak_saturation_", nam, ".complete_ChIP_input_saturation"), stat = peaksat:::valid_stats$qValue, stat_value = .01)
