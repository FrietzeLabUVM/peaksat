...
bam_files = dir("bam_file_inputs/bam_files_H4_ac_old_seq.pooled", pattern = "bam$", full.names = TRUE)
...
psc = peaksat_config(out_dir = "peak_saturation_10A_H4ac_seq1_only")

todo_df = data.frame(chip = bam_files, stringsAsFactors = FALSE)
